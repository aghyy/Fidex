            ...
            <form onSubmit={handleProfileUpdate} className="space-y-5">
              ...
              <div className="border-t pt-4 space-y-2">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center rounded-md px-3 py-2 text-sm gap-2 bg-destructive text-destructive-foreground hover:bg-destructive/90 transition-colors"
                  title="Sign out"
                  aria-label="Sign out"
                >
